...
my $unveilFiles=getFiles($unveil);
my $cdnaFiles=getFiles($cdna);
my $numUnveil=@$unveilFiles;
my $numCdna=@$cdnaFiles;
my $totalBases;
my $totalCoding;

my $numFiles=min($numUnveil,$numCdna);
...
print STDOUT "         |SN  SP   ACC|SN  SP |SN  SP |SN  SP  F  |GENES\n";

evaluateNuc("Unveil   ",$unveilFiles,$numFiles,$cdnaFiles,$unveil,$cdna);
evaluateExons("Unveil   ",$unveilFiles,$numFiles,$cdnaFiles,$unveil,$cdna);
evaluateGenes("Unveil   ",$unveilFiles,$numFiles,$cdnaFiles,$unveil,$cdna);
...
#############################
    ...
    my $F=int(2*$exonSpecificity*$exonSensitivity/
