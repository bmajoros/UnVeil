...
my $desertPercent=int(100*$totalDesert/$totalGenomeSize+0.5);
my $codingPercent=int(100*$totalCoding/$totalGenomeSize+0.5);
my $noncodingPercent=int(100*$totalNoncoding/$totalGenomeSize+0.5);
my $extentPercent=int(100*$totalGeneExtent/$totalGenomeSize+0.5);
my $intronPercent=int(100*$totalIntron/$totalGenomeSize+0.5);
...
$meanExon=int(100*$meanExon+0.5)/100;
$sdExon=int(100*$sdExon+0.5)/100;
my $n=@exonSizes;
...
$meanIntron=int(100*$meanIntron+0.5)/100;
$sdIntron=int(100*$sdIntron+0.5)/100;
my $n=@intronSizes;
...
$meanDesert=int(100*$meanDesert+0.5)/100;
$sdDesert=int(100*$sdDesert+0.5)/100;
my $n=@desertSizes;
...
$meanExonCount=int(100*$meanExonCount+0.5)/100;
$sdExonCount=int(100*$sdExonCount+0.5)/100;
my $n=@exonsPerGene;
...
$meanGeneSize=int(100*$meanGeneSize+0.5)/100;
$sdGeneSize=int(100*$sdGeneSize+0.5)/100;
my $n=@geneSizes;
